...
public class FourthTableModel extends AbstractTableModel {

	private List<Pacient> pacients;
	private JButton button = new JButton("Raport");
	String[] columnNames = { "Nume pacient", "Ora programare", "Analize", "Adaugare raport analize" };

...
public class ProfitUnitatiMedicale extends JFrame {
	...
	public ProfitUnitatiMedicale(DefaultDBConnection connection, int id) {
		...
		try {
			...
			stm.execute(" select sum(servicii.pret),unitati_medicale.Denumire from  "
					+ " programari,programari_servicii,servicii, raport_medical,angajat,medic,unitati_medicale where "
					...
					+ " and angajat.idUnitate=unitati_medicale.idUnitateMedicala"
					+ " group by unitati_medicale.idUnitateMedicala;");
		...
		btnInapoi.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				ProfitUnitatiMedicale.this.setVisible(false);

...
public class SalariuMedic extends JFrame implements ActionListener {
	...
	public SalariuMedic(DefaultDBConnection connection, int id) {
		...
		try {
			...
			while (i < 6) {
				PreparedStatement stm = this.connection.getConnection()
						.prepareStatement("select policlinici.calculare_medic(?,?) as salar from dual;");

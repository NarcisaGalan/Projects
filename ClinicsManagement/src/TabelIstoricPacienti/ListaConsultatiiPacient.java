...
import TabelRapoarteBonFiscal.ThirdTableModel;

public class ListaConsultatiiPacient extends JFrame implements ActionListener {
	...
	public ListaConsultatiiPacient(DefaultDBConnection con, int id) {
		this.connection = con;
		this.id = id;
		this.setTitle("Istoric pacientiiiii");
	...
	public void setTableModel(ThirdTableModel myTableModel) {

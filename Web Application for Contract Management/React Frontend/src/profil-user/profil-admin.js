...
class ProfilAdmin extends React.Component {
    ...
    handleValidSubmit() {
        if(this.state.parolaNoua === this.state.parolaVerfica){
            ...
            console.log("parola noua: " + this.state.parolaNoua);
            ...
            <div >
                ...
                <Row style={{marginBottom:"30px"}}>
                        ...
                        <Container fluid style={{ marginLeft: '40px', marginTop: '20px' }} className="block-example border border-danger" >
                            ...
                            <Table responsive size="sm" borderless>
                                ...
                                <tbody>
                                    ...
                                    <tr><td style={{ color: '#bd1515' }}>Nume: {localStorage.getItem("numeMembru")}</td></tr>
                                    <tr><td style={{ color: '#bd1515' }}>Functie: {localStorage.getItem("functieMembru")}</td></tr>
                    ...
                    <Modal isOpen={this.state.isActive} toggle={this.toggleModal} >
                        ...
                        <ModalBody>
                        <h2 id="help-message">Parola trebuie sa contina cel putin un numar, o litera mare si una mica, un caracter special si sa aiba cel putin 8 caractere</h2>
...
export default withRouter(ProfilAdmin);